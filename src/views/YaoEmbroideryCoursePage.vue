<template>
  <div
    class="min-h-screen bg-gradient-to-br from-emerald-50 via-blue-50 to-purple-50"
  >
    <!-- 顶部导航 -->
    <header
    ...
    <section class="relative py-16 overflow-hidden">
      <div
        class="absolute inset-0 bg-gradient-to-r from-emerald-600 via-blue-600 to-purple-600 opacity-90"
      ></div>
      <div class="absolute inset-0">
        <div
          class="absolute inset-0 bg-[url('/yao-embroidery-pattern.svg')] opacity-10 bg-repeat bg-center"
        ></div>
      </div>
      <div
      ...
      >
        <h2
          class="text-4xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-100"
        >
          陕北瑶绣艺术之旅
        </h2>
              ...
              <div class="flex flex-col lg:flex-row items-center gap-8">
                ...
                <div class="relative flex-shrink-0">
                  ...
                  >
                    ...
                    />
                    <PlayIcon
                      v-else-if="module.status === 'current'"
                      class="w-4 h-4"
                    />
                ...
                >
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    ...
                    >
                      <div
                        class="w-2 h-2 bg-emerald-400 rounded-full flex-shrink-0"
                      ></div>
                      <span>{{ point }}</span>
                    </div>
                  </div>
