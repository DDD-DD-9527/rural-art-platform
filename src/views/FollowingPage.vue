  ...
  >
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-24">
            ...
            <div class="flex items-center space-x-4">
              ...
              <div class="flex-1">
                <div class="flex items-center space-x-2">
                  ...
                  <span
                    v-if="user.isVip"
                    class="px-2 py-1 bg-gradient-to-r from-amber-400 to-orange-500 text-white text-xs rounded-full font-medium"
                  >
                    VIP
                  </span>
                  <span
                ...
                <p v-if="user.bio" class="text-sm text-slate-500 mt-1">
                  {{ user.bio }}
                </p>
              </div>
            </div>
      ...
      <div
        ...
        class="glass-card rounded-3xl p-6 mt-8"
      >
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          >
            ...
            <p class="text-sm text-slate-500 mb-3">
              {{ user.followers }} 粉丝 · {{ user.works }} 作品
            </p>
            <button
