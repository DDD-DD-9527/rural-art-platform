    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-24">
      ...
      <div class="glass-effect rounded-3xl p-6 mb-8">
        <div class="text-center mb-6">
          <div
            class="w-20 h-20 bg-gradient-to-br from-amber-500 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg"
          >
        ...
        <div
          v-if="currentMember.level !== '钻石会员'"
          class="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-4"
        >
          <div class="flex items-center justify-between">
            ...
            <button
              class="bg-gradient-to-r from-amber-500 to-orange-600 text-white px-6 py-2 rounded-xl font-semibold hover:shadow-lg transition-all duration-300"
            >
              立即升级
            </button>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div
            ...
            :class="[
              ...
              plan.popular
                ? 'border-gradient-to-r from-amber-500 to-orange-600 bg-gradient-to-br from-amber-50 to-orange-50'
                : 'border-slate-200 glass-effect',
            ]"
          ...
          >
            ...
            >
              <span
                class="bg-gradient-to-r from-amber-500 to-orange-600 text-white px-4 py-1 rounded-full text-sm font-semibold"
              >
                最受欢迎
              </span>
            </div>
...
const membershipPlans = reactive([
  {
    ...
    popular: false,
    features: ["每月10次AI创作", "1GB云端存储", "基础教程访问", "社区互动功能"],
  },
  {
    id: 2,
    name: "黄金会员",
...
const selectPlan = (plan) => {
  if (plan.name === currentMember.value.level) return;
