...
const learningRecords = reactive([
  {
    ...
    completedLessons: 3,
    courses: [
      { id: 1, name: '传统剪纸艺术入门', duration: '1.5小时' },
      { id: 2, name: '手机摄影技巧', duration: '1小时' },
      { id: 3, name: '水墨画基础', duration: '1小时' }
    ]
  },
  {
    id: 2,
    ...
    completedLessons: 2,
    courses: [
      { id: 4, name: '微信小程序运营', duration: '1.5小时' },
      { id: 5, name: '书法艺术欣赏', duration: '0.5小时' }
    ]
  },
  {
    id: 3,
    ...
    completedLessons: 4,
    courses: [
      { id: 6, name: '短视频制作入门', duration: '2小时' },
      { id: 7, name: '陶艺制作基础', duration: '1.5小时' },
      { id: 8, name: '风景摄影技巧', duration: '0.5小时' }
    ]
  },
  {
    id: 4,
    ...
    completedLessons: 1,
    courses: [
      { id: 9, name: '民间音乐欣赏', duration: '1.5小时' }
    ]
  },
  {
    id: 5,
    ...
    completedLessons: 2,
    courses: [
      { id: 10, name: '电商平台运营', duration: '2小时' },
      { id: 11, name: '编织工艺入门', duration: '0.5小时' }
    ]
  },
  {
    id: 6,
    ...
    completedLessons: 3,
    courses: [
      { id: 12, name: '人像摄影基础', duration: '1.5小时' },
      { id: 13, name: '传统文化讲座', duration: '1小时' },
      { id: 14, name: '数字技能提升', duration: '0.5小时' }
    ]
  },
  {
    id: 7,
    ...
    completedLessons: 2,
    courses: [
      { id: 15, name: '乡村艺术创作', duration: '1小时' },
      { id: 16, name: '手工制作技巧', duration: '1小时' }
    ]
  },
  {
    id: 8,
    ...
    completedLessons: 1,
    courses: [
      { id: 17, name: '艺术鉴赏入门', duration: '1小时' }
    ]
  },
  {
    id: 9,
    ...
    completedLessons: 2,
    courses: [
      { id: 18, name: '传统手工艺', duration: '1.5小时' },
      { id: 19, name: '摄影后期处理', duration: '1小时' }
    ]
  },
  {
    id: 10,
    ...
    completedLessons: 3,
    courses: [
      { id: 20, name: '国画技法进阶', duration: '2小时' },
      { id: 21, name: '文化传承讲座', duration: '1小时' },
      { id: 22, name: '创意设计基础', duration: '0.5小时' }
    ]
  },
  {
    id: 11,
    ...
    completedLessons: 2,
    courses: [
      { id: 23, name: '乡村摄影技巧', duration: '1小时' },
      { id: 24, name: '手工编织进阶', duration: '1小时' }
    ]
  },
  {
    id: 12,
    ...
    completedLessons: 1,
    courses: [
      { id: 25, name: '传统文化研习', duration: '1.5小时' }
    ]
  }
])
