    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-24">
      ...
      <div class="glass-card rounded-3xl p-6 mb-6">
        <div class="text-center mb-6">
          <div class="text-4xl font-bold text-violet-600 mb-2">
            {{ totalLearningDays }}
          </div>
      ...
      <div class="glass-card rounded-2xl p-6 mb-6">
        ...
        <div class="flex items-center justify-between mb-3">
          <span class="text-sm font-medium text-slate-600"
            >已学习 {{ thisMonthDays }} 天</span
          >
          <span class="text-sm font-medium text-slate-600"
            >目标 {{ monthlyGoal }} 天</span
          >
        </div>
        ...
        <div class="text-center text-sm text-slate-600">
          {{
            goalProgress >= 100
              ? "🎉 恭喜完成本月目标！"
              : `还需学习 ${monthlyGoal - thisMonthDays} 天完成目标`
          }}
        </div>
      </div>
        ...
        <div class="grid grid-cols-7 gap-2">
          <div
            ...
            :class="[
              ...
              date.isCurrentMonth ? 'text-slate-800' : 'text-slate-400',
              date.isToday
          ...
          >
            {{ date.day }}
            <div
              v-if="date.hasLearning && !date.isToday"
              class="absolute bottom-1 right-1 w-2 h-2 bg-emerald-500 rounded-full"
            ></div>
          </div>
        </div>
      </div>
        ...
        >
          <div class="flex items-center justify-between mb-3">
            <div class="flex items-center space-x-3">
              <div
                class="w-12 h-12 bg-gradient-to-br from-violet-100 to-purple-100 rounded-xl flex items-center justify-center"
              >
...
const goalProgress = computed(() =>
  Math.min(100, (thisMonthDays.value / monthlyGoal.value) * 100),
);
