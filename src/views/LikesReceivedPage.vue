<template>
  ...
  >
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-24">
      ...
      <div class="space-y-4">
        <div
          v-for="like in paginatedLikes"
          :key="like.id"
          class="glass-card rounded-2xl p-6"
        >
          <div class="flex items-start space-x-4">
            <div
              class="w-12 h-12 rounded-full bg-gradient-to-br from-rose-400 to-pink-500 flex items-center justify-center flex-shrink-0"
            >
            ...
            <div class="flex-1">
              ...
              <p class="text-slate-600 mb-3">
                赞了你的{{ like.contentType }}：
              </p>
              <div class="bg-slate-50 rounded-xl p-4">
                <p class="text-slate-700">{{ like.content }}</p>
                <div v-if="like.image" class="mt-3">
                  <div
                    class="w-20 h-20 bg-gradient-to-br from-emerald-100 to-blue-100 rounded-lg flex items-center justify-center"
                  >
