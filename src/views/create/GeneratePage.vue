<template>
  ...
  >
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-24">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          >
            <div class="text-center">
              <div
                class="w-16 h-16 mx-auto mb-3 rounded-xl bg-gradient-to-br from-orange-100 to-red-100 flex items-center justify-center"
              >
      ...
      <div class="glass-effect rounded-3xl p-8 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            ...
            >
            <select
              v-model="patternSettings.complexity"
              class="w-full p-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
            >
          ...
          <div>
            ...
            >
            <select
              v-model="patternSettings.colorScheme"
              class="w-full p-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
            >
          ...
          <div>
            ...
            >
            <select
              v-model="patternSettings.patternType"
              class="w-full p-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
            >
      ...
      <!-- 生成结果 -->
      <div
        v-if="generatedPatterns.length > 0"
