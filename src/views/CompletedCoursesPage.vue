      ...
      <div class="space-y-4 mb-8">
        ...
        >
          <div class="flex items-start space-x-4">
            <div
              class="w-16 h-16 bg-gradient-to-br from-emerald-100 to-blue-100 rounded-xl flex items-center justify-center flex-shrink-0"
            >
      ...
      <div class="glass-card rounded-2xl p-4">
        <div class="flex items-center justify-between">
          <div class="text-sm text-slate-600">
            ...
            条，共 {{ filteredCourses.length }} 条记录
          </div>
          <div class="flex items-center space-x-2">
            <button
...
const filteredCourses = computed(() => {
  ...
  return completedCourses.filter(
    (course) => course.categoryId === selectedCategory.value,
  );
});
