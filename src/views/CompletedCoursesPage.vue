...
const completedCourses = reactive([
  {
    id: 1,
    title: '传统剪纸艺术入门',
    description: '学习传统剪纸的基本技法，从简单的花鸟图案开始，逐步掌握复杂的剪纸技艺。',
    category: '艺术教育',
    categoryId: 'art',
    duration: '4小时',
  ...
  },
  {
    id: 2,
    title: '手机摄影技巧提升',
    description: '掌握手机摄影的构图、光线运用等技巧，拍出专业级的照片作品。',
    category: '数字技能',
    categoryId: 'digital',
    duration: '3小时',
  ...
  },
  {
    id: 3,
    title: '水墨画基础教程',
    description: '从握笔姿势开始，学习水墨画的基本技法和意境表达。',
    category: '艺术教育',
    categoryId: 'art',
    duration: '6小时',
  ...
  },
  {
    id: 4,
    title: '微信小程序运营',
    description: '学习微信小程序的运营策略，提升农产品线上销售能力。',
    category: '数字技能',
    categoryId: 'digital',
    duration: '5小时',
  ...
  },
  {
    id: 5,
    title: '书法艺术欣赏与实践',
    description: '了解书法艺术的历史发展，学习基本的书写技巧。',
    category: '艺术教育',
    categoryId: 'art',
    duration: '4小时',
  ...
  },
  {
    id: 6,
    title: '短视频制作入门',
    description: '学习短视频的拍摄、剪辑和发布技巧，展示乡村生活之美。',
    category: '数字技能',
    categoryId: 'digital',
    duration: '3小时',
  ...
  },
  {
    id: 7,
    title: '陶艺制作基础',
    description: '学习陶艺的基本技法，制作简单的陶瓷作品。',
    category: '手工制作',
    categoryId: 'craft',
    duration: '5小时',
  ...
  },
  {
    id: 8,
    title: '风景摄影技巧',
    description: '掌握风景摄影的构图和拍摄技巧，记录家乡美景。',
    category: '摄影技巧',
  ...
  },
  {
    id: 9,
    title: '民间音乐欣赏',
    description: '了解传统民间音乐的特色，学习简单的乐器演奏。',
    category: '艺术教育',
    categoryId: 'art',
    duration: '3小时',
  ...
  },
  {
    id: 10,
    title: '电商平台运营',
    description: '学习电商平台的运营技巧，提升农产品销售效果。',
    category: '数字技能',
    categoryId: 'digital',
    duration: '6小时',
  ...
  },
  {
    id: 11,
    title: '编织工艺入门',
    description: '学习传统编织工艺，制作实用的生活用品。',
    category: '手工制作',
    categoryId: 'craft',
    duration: '4小时',
  ...
  },
  {
    id: 12,
    title: '人像摄影基础',
    description: '学习人像摄影的基本技巧，拍出自然生动的人物照片。',
    category: '摄影技巧',
    categoryId: 'photography',
    duration: '5小时',
