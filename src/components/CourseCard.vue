  ...
  >
    <div class="relative">
      ...
      <div class="absolute top-4 right-4">
        <div
          class="w-12 h-12 glass-morphism rounded-full flex items-center justify-center shadow-lg"
        >
    ...
    <div class="p-6">
      <h3
        class="text-xl font-bold mb-3 group-hover:text-emerald-600 transition-colors duration-300"
      >
        {{ course.title }}
      </h3>
      ...
      <div
        class="flex items-center justify-between text-sm text-slate-500 mb-6"
      >
      ...
      <button
        class="w-full py-4 gradient-primary hover:shadow-lg text-white rounded-2xl font-bold transition-all duration-300 transform hover:scale-105"
      >
