<template>
  <div class="achievement-system">
    ...
    <div class="achievement-overview glass-card rounded-3xl p-8 mb-8 shadow-xl">
        ...
        <div class="relative">
          <svg class="w-32 h-32 transform -rotate-90" viewBox="0 0 120 120">
            ...
            <circle
              ...
              :stroke-dashoffset="
                circumference - (achievementProgress / 100) * circumference
              "
      ...
      <div v-if="recentAchievements.length > 0" class="recent-achievements">
        ...
        <div class="flex space-x-4 overflow-x-auto pb-2">
          ...
          >
            <div
              class="w-16 h-16 mx-auto mb-2 rounded-full bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center shadow-lg"
            >
              <component
      ...
      <div class="flex flex-wrap gap-2 justify-center">
        ...
        >
          ...
          <span class="text-xs opacity-75"
            >({{ getCategoryCount(category.value) }})</span
          >
        </button>
      </div>
    </div>
    ...
    <!-- 成就网格 -->
    <div
      class="achievements-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"
    >
      <div
      ...
      >
        ...
        <div class="relative mb-4">
          ...
          <div v-if="achievement.unlocked" class="absolute -top-2 -right-2">
            <div
              class="w-8 h-8 bg-emerald-500 rounded-full flex items-center justify-center shadow-lg"
            >
        ...
        <div class="text-center">
          ...
          <div class="space-y-4">
            ...
            >
              ...
              <span class="font-semibold text-yellow-600"
                >+{{ selectedAchievement.points }}</span
              >
            </div>
            ...
            >
              ...
              <span
                :class="[
                  'font-semibold',
                  getRarityTextClass(selectedAchievement.rarity),
                ]"
              >
            ...
            <div
              ...
              class="flex justify-between items-center p-3 bg-emerald-50 rounded-xl"
            >
            ...
            <div
              v-else-if="selectedAchievement.progress !== undefined"
          ...
          >
            <div class="text-sm text-blue-800">
              <strong>解锁条件：</strong
              >{{ selectedAchievement.unlockHint || "继续学习即可解锁" }}
            </div>
          </div>
        </div>
      </div>
...
const loadAchievements = async () => {
  try {
    ...
    if (response.success) {
      achievements.value = (response.data?.achievements || []).map(
        (achievement) => ({
          ...achievement,
          progress:
