      ...
      <div class="flex-1 min-w-0">
        ...
        <div class="flex items-center justify-between mb-2">
          <div class="flex items-center space-x-2">
            ...
            <span
              ...
              class="px-2 py-0.5 bg-blue-100 text-blue-600 text-xs rounded-full"
            >
              专家
            </span>
            <span
              v-if="comment.isPinned"
              class="px-2 py-0.5 bg-yellow-100 text-yellow-600 text-xs rounded-full"
            >
              置顶
            </span>
          </div>
        ...
        <div class="mb-3">
          ...
          >
            ...
            >
              @{{ mention.username
              }}<span v-if="index < comment.mentions.length - 1">, </span>
            </span>
          </div>
        </div>
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-4">
            ...
            <!-- 回复数量 -->
            <span
              v-if="comment.stats?.replyCount > 0"
