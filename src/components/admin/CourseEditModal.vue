                        ...
                        <div class="col-span-2" v-if="lesson.type === 'video'">
                          ...
                          <div class="mt-1 flex items-center space-x-4">
                            ...
                            <input
                              ...
                              accept="video/*"
                              @change="
                                (event) => handleLessonVideoUpload(event, index)
                              "
                              class="hidden"
                            />
                            <button
                          ...
                          <div
                            v-if="lesson.uploadProgress !== undefined"
                            class="mt-2"
                          >
                ...
                <div v-show="activeTab === 'settings'" class="space-y-6">
                  ...
                  <div class="border-t border-gray-200 pt-6">
                    ...
                    <div class="grid grid-cols-2 gap-4 sm:grid-cols-4">
                      ...
                      <div class="text-center">
                        <div class="text-2xl font-bold text-gray-900">
                          {{ course.stats?.completedCount || 0 }}
                        </div>
                        <div class="text-sm text-gray-500">完成人数</div>
                      </div>
                      <div class="text-center">
                        <div class="text-2xl font-bold text-gray-900">
                          {{ course.stats?.viewCount || 0 }}
                        </div>
